...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff37cdcfcf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='netifaces', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff37cdcfcf8>, origin='/usr/lib/python3/dist-packages/netifaces.cpython-36m-x86_64-linux-gnu.so')"
