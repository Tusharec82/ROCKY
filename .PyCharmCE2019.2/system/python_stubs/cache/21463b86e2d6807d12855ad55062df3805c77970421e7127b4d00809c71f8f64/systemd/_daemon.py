...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3bbd885cc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._daemon', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3bbd885cc0>, origin='/usr/lib/python3/dist-packages/systemd/_daemon.cpython-36m-x86_64-linux-gnu.so')"
