...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1265fa8cc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd.id128', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1265fa8cc0>, origin='/usr/lib/python3/dist-packages/systemd/id128.cpython-36m-x86_64-linux-gnu.so')"
