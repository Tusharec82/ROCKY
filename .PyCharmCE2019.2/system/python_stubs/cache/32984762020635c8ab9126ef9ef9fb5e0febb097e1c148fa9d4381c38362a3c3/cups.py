...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f62a8d3fcf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='cups', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f62a8d3fcf8>, origin='/usr/lib/python3/dist-packages/cups.cpython-36m-x86_64-linux-gnu.so')"
