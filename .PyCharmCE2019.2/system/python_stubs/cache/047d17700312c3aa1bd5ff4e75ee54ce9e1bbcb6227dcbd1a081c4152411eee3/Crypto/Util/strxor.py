...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f6db5804eb8>'

__spec__ = None # (!) real value is "ModuleSpec(name='Crypto.Util.strxor', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f6db5804eb8>, origin='/usr/lib/python3/dist-packages/Crypto/Util/strxor.cpython-36m-x86_64-linux-gnu.so')"
