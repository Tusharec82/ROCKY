...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb01e6d0cf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='hpmudext', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb01e6d0cf8>, origin='/usr/lib/python3/dist-packages/hpmudext.cpython-36m-x86_64-linux-gnu.so')"
