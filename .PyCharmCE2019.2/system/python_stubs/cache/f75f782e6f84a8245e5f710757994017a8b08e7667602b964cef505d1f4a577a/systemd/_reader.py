...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff119602cc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._reader', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff119602cc0>, origin='/usr/lib/python3/dist-packages/systemd/_reader.cpython-36m-x86_64-linux-gnu.so')"
