...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a7af9bd30>'

__spec__ = None # (!) real value is "ModuleSpec(name='mmap', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a7af9bd30>, origin='/usr/lib/python3.6/lib-dynload/mmap.cpython-36m-x86_64-linux-gnu.so')"
