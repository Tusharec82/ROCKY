...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3367b2e828>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._journal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3367b2e828>, origin='/usr/lib/python3/dist-packages/systemd/_journal.cpython-36m-x86_64-linux-gnu.so')"
