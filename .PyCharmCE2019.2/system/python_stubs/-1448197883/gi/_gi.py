...
TYPE_GSTRING = None # (!) real value is '<GType GString (29705168)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f465a63b690>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f465a63b630>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f465b26a5c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f465b26a5c0>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-36m-x86_64-linux-gnu.so')"
