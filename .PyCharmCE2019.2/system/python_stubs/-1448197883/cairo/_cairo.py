...
CAPI = None # (!) real value is '<capsule object "cairo.CAPI" at 0x7efc0b5e31b0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efc0b5fae80>'

__spec__ = None # (!) real value is "ModuleSpec(name='cairo._cairo', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efc0b5fae80>, origin='/usr/lib/python3/dist-packages/cairo/_cairo.cpython-36m-x86_64-linux-gnu.so')"
