...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28d823ecf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='pcardext', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28d823ecf8>, origin='/usr/lib/python3/dist-packages/pcardext.cpython-36m-x86_64-linux-gnu.so')"
