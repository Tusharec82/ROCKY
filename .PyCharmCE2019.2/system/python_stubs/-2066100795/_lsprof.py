...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f493624cd30>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lsprof', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f493624cd30>, origin='/usr/lib/python3.6/lib-dynload/_lsprof.cpython-36m-x86_64-linux-gnu.so')"
