...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7fd313a53210>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd313a4acf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd313a4acf8>, origin='/usr/lib/python3.6/lib-dynload/_curses.cpython-36m-x86_64-linux-gnu.so')"
