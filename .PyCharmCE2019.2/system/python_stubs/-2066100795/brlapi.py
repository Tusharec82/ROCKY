...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7ee90cbd30>'

__spec__ = None # (!) real value is "ModuleSpec(name='brlapi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7ee90cbd30>, origin='/usr/lib/python3/dist-packages/brlapi.cpython-36m-x86_64-linux-gnu.so')"
