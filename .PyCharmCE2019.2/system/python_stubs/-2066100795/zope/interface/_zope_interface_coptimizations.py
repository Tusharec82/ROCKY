...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f493b860588>'

__spec__ = None # (!) real value is "ModuleSpec(name='zope.interface._zope_interface_coptimizations', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f493b860588>, origin='/usr/lib/python3/dist-packages/zope/interface/_zope_interface_coptimizations.cpython-36m-x86_64-linux-gnu.so')"
