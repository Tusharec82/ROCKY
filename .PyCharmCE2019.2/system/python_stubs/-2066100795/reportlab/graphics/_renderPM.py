...
# from /usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1f487912b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='reportlab.graphics._renderPM', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1f487912b0>, origin='/usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-36m-x86_64-linux-gnu.so')"
