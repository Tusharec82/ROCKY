...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9da041ecf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='readline', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9da041ecf8>, origin='/usr/lib/python3.6/lib-dynload/readline.cpython-36m-x86_64-linux-gnu.so')"
