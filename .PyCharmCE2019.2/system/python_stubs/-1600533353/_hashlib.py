...
openssl_md_meth_names = None # (!) real value is "frozenset({'blake2b512', 'MD5-SHA1', 'sha512', 'RIPEMD160', 'md5', 'sha256', 'whirlpool', 'BLAKE2s256', 'MD4', 'md5-sha1', 'SHA512', 'sha1', 'BLAKE2b512', 'ripemd160', 'SHA1', 'SHA384', 'SHA224', 'md4', 'sha384', 'sha224', 'SHA256', 'blake2s256', 'MD5'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f480e14b3c8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f480e14b3c8>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
