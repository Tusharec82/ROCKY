...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3b134a9cf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='ossaudiodev', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3b134a9cf8>, origin='/usr/lib/python3.6/lib-dynload/ossaudiodev.cpython-36m-x86_64-linux-gnu.so')"
