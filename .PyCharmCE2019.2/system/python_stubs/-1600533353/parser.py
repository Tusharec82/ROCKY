...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f321de13cc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='parser', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f321de13cc0>, origin='/usr/lib/python3.6/lib-dynload/parser.cpython-36m-x86_64-linux-gnu.so')"
