...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc0ce2eacc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc0ce2eacc0>, origin='/usr/lib/python3.6/lib-dynload/_decimal.cpython-36m-x86_64-linux-gnu.so')"
